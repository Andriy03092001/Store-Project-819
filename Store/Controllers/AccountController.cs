        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    var adminId = _context.Roles.FirstOrDefault(t=>t.Name == "Admin").Id;

                    var statusRole = _context.Set<IdentityUserRole>().FirstOrDefault(t => t.UserId == userId && t.RoleId == adminId);
